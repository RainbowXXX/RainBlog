...
export function TOCSidebar({contentSelector = "article"}: TOCSidebarProps) {
    ...
    return (
        <>
            {/* Desktop TOC */}
            <div
                className="hidden lg:block fixed right-4 xl:right-8 top-1/3 max-w-[220px] max-h-[60vh] overflow-y-auto bg-background border rounded-lg p-4 shadow-sm toc-sidebar">
