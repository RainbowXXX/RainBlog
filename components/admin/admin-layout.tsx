...
import {BarChart2, Bell, ChevronRight, FileText, Home, LogOut, Search, Settings, User, Users} from "lucide-react"
                            ...
                            <SidebarMenuItem key={item.title}>
                                {item.href ? (
                                    ...
                                    <SidebarMenuButton className="flex items-center gap-3 font-medium">
                                        ...
                                        <span>{item.title}</span>
                                        <ChevronRight
                                            className="ml-auto h-4 w-4 transition-transform [&[data-state=open]>svg]:rotate-90"/>
                                    </SidebarMenuButton>
                                )}
