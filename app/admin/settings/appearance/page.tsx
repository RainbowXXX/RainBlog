            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    <Input id="secondary-color" type="color" defaultValue="#6b7280" className="w-12 h-10 p-1" />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    <Input id="background-color" type="color" defaultValue="#ffffff" className="w-12 h-10 p-1" />
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    <Input id="text-color" type="color" defaultValue="#1f2937" className="w-12 h-10 p-1" />
